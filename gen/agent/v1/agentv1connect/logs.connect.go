...
const (
	...
	LogsStreamLogsProcedure = "/agent.v1.Logs/StreamLogs"
	// LogsUploadLogsProcedure is the fully-qualified name of the Logs's UploadLogs RPC.
	LogsUploadLogsProcedure = "/agent.v1.Logs/UploadLogs"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	logsServiceDescriptor          = v1.File_agent_v1_logs_proto.Services().ByName("Logs")
...
// NewLogsClient constructs a client for the agent.v1.Logs service. By default, it uses the Connect
...
// StreamLogs calls agent.v1.Logs.StreamLogs.
...
// UploadLogs calls agent.v1.Logs.UploadLogs.
...
func NewLogsHandler(svc LogsHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/agent.v1.Logs/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLogsHandler) StreamLogs(context.Context, *connect.Request[v1.StreamLogsRequest]) (*connect.Response[v1.StreamLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agent.v1.Logs.StreamLogs is not implemented"))
}
...
func (UnimplementedLogsHandler) UploadLogs(context.Context, *connect.Request[v1.UploadLogsRequest]) (*connect.Response[v1.UploadLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agent.v1.Logs.UploadLogs is not implemented"))
}
